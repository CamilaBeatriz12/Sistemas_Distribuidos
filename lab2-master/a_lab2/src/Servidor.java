...
public class Servidor {
	...
	public final static Path path = Paths.get("data\\fortune-br.txt");
	...
	public class FileReader {
		...
		public void write(HashMap<Integer, String> hm, String fortuneValue) throws FileNotFoundException {
			try {
